...
export const PLATFORMS: Record<string, Platform> = {
  ...
  flipkart: {
    ...
    layoutNote: "Centered shipping label (~3.7×5 in band) enlarged to 4×6 — invoice and side whitespace removed.",
  },
  meesho: {
    id: "meesho",
    name: "Meesho",
    ...
    layoutNote: "Shipping label on top (~60% of A4), tax invoice on the bottom — invoice pages removed automatically.",
  },
  fedex: {
    id: "fedex",
    name: "FedEx",
